...
{
    public class ControlServerDbContext : AuditableDbContext<ControlServerDbContext>
    {
        private readonly ICurrentUserService currentUserService;
        public ControlServerDbContext(DbContextOptions<ControlServerDbContext> options, ICurrentUserService currentUserService) : base(options)
        {
